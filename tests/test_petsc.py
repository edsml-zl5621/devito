...
@pytest.mark.parametrize('eqn, target, expected', [
    ('Eq(f1.laplace, g1)', 'f1', ('g1(x, y)', 'Derivative(f1(x, y), (x, 2)) + Derivative(f1(x, y), (y, 2))')),
    ('Eq(g1, f1.laplace)', 'f1', ('-g1(x, y)', '-Derivative(f1(x, y), (x, 2)) - Derivative(f1(x, y), (y, 2))')),

    ('Eq(g1, f1.laplace)', 'g1', ('Derivative(f1(x, y), (x, 2)) + Derivative(f1(x, y), (y, 2))', 'g1(x, y)')),

    ('Eq(f1 + f1.laplace, g1)', 'f1', ('g1(x, y)', 'f1(x, y) + Derivative(f1(x, y), (x, 2)) + Derivative(f1(x, y), (y, 2))')),

    ('Eq(g1.dx + f1.dx, g1)', 'f1', ('g1(x, y) - Derivative(g1(x, y), x)', 'Derivative(f1(x, y), x)')),
    ('Eq(g1.dx + f1.dx, g1)', 'g1', ('-Derivative(f1(x, y), x)', '-g1(x, y) + Derivative(g1(x, y), x)')),
